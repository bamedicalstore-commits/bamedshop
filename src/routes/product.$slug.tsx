    ...
    <SiteLayout>
      ...
      <article className="container-page grid gap-8 pb-16 lg:grid-cols-[minmax(0,1fr)_420px] lg:gap-12">
        ...
        <div className="lg:pt-2">
          ...
          <h1 className="mt-4 text-2xl font-semibold leading-tight tracking-[-0.03em] sm:text-3xl">
            {product.name}
          </h1>
          ...
          <p className="mt-2 text-xs text-muted-foreground">
            Prix affiché en TND. Les frais et modalités de livraison sont confirmés lors de la
            commande.
          </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-xs leading-5 text-muted-foreground">
              Votre demande est préparée avec le produit et la quantité sélectionnés. Notre équipe
              confirme ensuite disponibilité et livraison.
            </p>
          </div>

          <ul className="mt-6 divide-y divide-border rounded-xl border border-border bg-surface">
            <FeatureLine icon={ShieldCheck}>
              Informations produit vérifiées avant commande
            </FeatureLine>
...
function FeatureLine({
  ...
  return (
    <li className="flex items-center gap-3 px-4 py-3.5 text-sm">
