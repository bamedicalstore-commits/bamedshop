    ...
    <SiteLayout>
      <article className="container-page max-w-3xl py-14">
        <Button asChild variant="ghost" size="sm" className="mb-6">
          <Link to="/blog"><ArrowLeft aria-hidden="true" /> Retour au blog</Link>
        </Button>
        ...
        <div className="prose prose-neutral mt-10 max-w-none text-foreground">
          <p className="text-lg text-muted-foreground">
            Le contenu détaillé de cet article sera intégré au branchement du CMS. Cette page est
            un shell UI destiné à valider la mise en page éditoriale du blog BA Medical Store.
          </p>
          <p>
