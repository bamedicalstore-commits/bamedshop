...
const POSTS = [
  {
    slug: "choisir-tensiometre",
    title: "Comment bien choisir son tensiomètre pour un cabinet ?",
    excerpt: "Nos conseils experts pour investir dans un tensiomètre fiable et durable.",
    category: "Guides",
    date: "12 mars 2025",
    read: "5 min",
  },
  {
    slug: "hygiene-cabinet",
    title: "Protocoles d'hygiène en cabinet médical",
    excerpt: "Les bonnes pratiques pour un environnement sûr et conforme.",
  ...
  {
    slug: "kine-materiel",
    title: "Équipement essentiel du kinésithérapeute",
    excerpt: "Notre checklist complète pour équiper un cabinet de kiné.",
    category: "Guides",
...
export const Route = createFileRoute("/blog/")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Guides d'achat, bonnes pratiques et actualités du secteur médical.",
      },
      { property: "og:title", content: "Blog — BA Medical Store" },
      {
        property: "og:description",
        content: "Guides et bonnes pratiques pour professionnels de santé.",
      },
    ],
  }),
  component: BlogIndex,
