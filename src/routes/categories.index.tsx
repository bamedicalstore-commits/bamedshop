  ...
  head: () => ({
    meta: [
      { title: "Toutes les catégories — BA Medical Store" },
      {
        name: "description",
        content:
          "Explorez toutes nos catégories : diagnostic, consommables, mobilier, orthopédie, hygiène, laboratoire.",
      },
      ...
      <div className="container-page py-10">
        <header className="mb-8">
          ...
          <p className="mt-2 max-w-2xl text-muted-foreground">
            Notre matériel médical, organisé pour vous permettre de trouver rapidement ce dont vous
            avez besoin.
          </p>
        </header>
